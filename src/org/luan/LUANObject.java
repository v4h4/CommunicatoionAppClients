...
public class LUANObject implements Serializable{
	...
	public LUANObject(String luanObjectstring)throws Exception{
		if(luanObjectstring.substring(0, 6).equals("||||||")){
			initilizeLUANObject();
	...
	public LUANObject(byte[] luanObject)throws Exception{
		...
		luanObjectstring = new String(luanObject,"ISO-8859-1");
		if(luanObjectstring.substring(0, 6).equals("||||||")){
			initilizeLUANObject();
			readStringAndCreateLUANOBject(luanObjectstring);
		}else{
	...
	public String toString(){
		/*String toString = 
				convertStringMapToString()+",,,,,,,,,,,,"+
			    convertIntegerMapToString()+",,,,,,,,,,,,"+
			    convertDoubleMapToString()+",,,,,,,,,,,,"+
			    convertBooleanMapToString()+",,,,,,,,,,,,"+
			    convertByteArrayMapToString()+",,,,,,,,,,,,"+
			    convertStringArrayMapToString()+",,,,,,,,,,,,"+
			    convertIntegerArrayMapToString()+",,,,,,,,,,,,"+
			    convertDoubleArrayMapToString()+",,,,,,,,,,,,"+
			    convertBooleanArrayMapToString()+",,,,,,,,,,,,"+
			    convertTwoDimensionalIntegerArrayMapToString()+",,,,,,,,,,,,"+
			    convertTwoDimensionalDoubleArrayMapToString()+",,,,,,,,,,,,"+
			    convertTwoDimensionalBooleanArrayMapToString()+",,,,,,,,,,,,"+
			    convertTwoDimensionalStringArrayMapToString()+",,,,,,,,,,,,"+
				enderMapToString();
			    */
		String toString=""; 
		if(intMap.size()>0){
	...
	private String convertStringMapToString(){
		String string_for_stringMap="||||||stringMap;;;;;;";
	...
	private String convertIntegerMapToString(){
		String string_for_intMap="||||||intMap;;;;;;";
	...
	private String convertDoubleMapToString(){
		String string_for_doubleMap="||||||doubleMap;;;;;;";
	...
	private String convertBooleanMapToString(){
		String string_for_booleanMap="||||||booleanMap;;;;;;";
	...
	private String convertStringArrayMapToString(){
		String string_for_stringArrMap="||||||stringArrMap;;;;;;";
	...
	private String convertIntegerArrayMapToString(){
		String string_for_intArrMap="||||||intArrMap;;;;;;";
	...
	private String convertDoubleArrayMapToString(){
		String string_for_doubleArrMap="||||||doubleArrMap;;;;;;";
	...
	private String convertBooleanArrayMapToString(){
		String string_for_booleanArrMap="||||||booleanArrMap;;;;;;";
	...
	private String convertTwoDimensionalIntegerArrayMapToString(){
		String string_for_int2dArrMap="||||||intTwoDimensionalArrMap;;;;;;";
	...
	private String convertTwoDimensionalDoubleArrayMapToString(){
		String string_for_Double2dArrMap="||||||doubleTwoDimensionalArrMap;;;;;;";
	...
	private String convertTwoDimensionalBooleanArrayMapToString(){
		String string_for_boolean2dArrMap="||||||booleanTwoDimensionalArrMap;;;;;;";
	...
	private String convertTwoDimensionalStringArrayMapToString(){
		String string_for_string2dArrMap="||||||stringTwoDimensionalArrMap;;;;;;";
	...
	private String enderMapToString(){
		String string_for_enderMap="||||||Ender;;;;;;";
		string_for_enderMap=string_for_enderMap+"{{{{{{ :::::: }}}}}},,,,,,||||||";
		return string_for_enderMap;
	}
	
	private String convertByteArrayMapToString(){
		String string_for_byteArrMap="";
		try{
	...
	private String convertToString(int[] intArr){
		String intArray="[[[[[[";
	...
	private String convertToString(String[] stringArr){
		String stringArray="[[[[[[";
	...
	private String convertToString(boolean[] booleanArr){
		String booleanArray="[[[[[[";
	...
	private String convertTwoDimensionalToString(int[][] intArr){
		String stringIntArray="";
		for(int i=0;i<intArr.length;i++){
	...
	private String convertTwoDimensionalToString(double[][] doubleArr){
	...
	private String convertTwoDimensionalToString(boolean[][] booleanArr){
		String stringBooleanArray="";
		for(int i=0;i<booleanArr.length;i++){
	...
	private String convertTwoDimensionalToString(String[][] stringArr){
		String stringArray="";
		for(int i=0;i<stringArr.length;i++){
	...
	private void segment_SortOutAndInitlizeMaps(ArrayList <String>mapList){
		for(int i=0;i<mapList.size();i++){
			...
			int seperator=0;
			for(int q=0;(q+6)<string.length();q++){
				if(string.substring(q,q+6).equals(";;;;;;")){
					seperator=q+6;
				}
			}
			String map="";
			...
			if(seperator>=6){
				...
				mapName=string.substring(0, seperator-6);
	...
	private void initilizeIntMap(String map){
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				beginIndex=q+6;
			}else if(q<map.length()-6 && map.substring(q,q+6).equals("}}}}}}")){
				endIndex=q;
				keyAndValue=map.substring(beginIndex, endIndex);
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						value=Integer.parseInt(keyAndValue.substring(i+6, keyAndValue.length()));
						intMap.put(key, value);
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						value=Double.parseDouble(keyAndValue.substring(i+6, keyAndValue.length()));
						doubleMap.put(key, value);
						i=keyAndValue.length()+1;
					}
				}
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						value=Boolean.parseBoolean(keyAndValue.substring(i+6, keyAndValue.length()));
						booleanMap.put(key, value);
						i=keyAndValue.length()+1;
					}
				}
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						value=keyAndValue.substring(i+6, keyAndValue.length());
						stringMap.put(key, value);
						i=keyAndValue.length()+1;
					}
				}
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String intArr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String doubleArr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String booleanArr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String stringArr=keyAndValue.substring(i+6, keyAndValue.length());
	...
	private void initilizeByteArrMap(String map){
		...
		byte[] value=null;
		//System.out.println("map == "+map);
		//System.out.println("INNE I initilizeByteArrMap");
		//System.exit(0);
		for(int q=0;(q+6)<map.length();q++){//takes out the key & value
			if(map.substring(q, q+6).equals("{{{{{{")){
				beginIndex=q+6;
			}else if(map.substring(q, q+6).equals("}}}}}}")){
				endIndex=q+6;
				keyAndValue=map.substring(beginIndex, endIndex);
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						try {
							///System.out.println("keyAndValue.substring("+i+"+6, "+keyAndValue.length()+") == "+keyAndValue.substring(i+6, keyAndValue.length()));
							//System.exit(0);
							value=keyAndValue.substring(i+6, keyAndValue.length()).getBytes("ISO-8859-1");
						} catch (Exception ex) {
							ex.printStackTrace();
						}
						byteArrMap.put(key, value);
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String int2D_Arr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String double2D_Arr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String boolean2D_Arr=keyAndValue.substring(i+6, keyAndValue.length());
		...
		for(int q=0;q<map.length();q++){//takes out the key & value
			if(q<map.length()-6 && map.substring(q,q+6).equals("{{{{{{")){
				...
				for(int i=0;i<keyAndValue.length();i++){//seperates key & value
					if(keyAndValue.substring(i, i+6).equals("::::::")){
						key=keyAndValue.substring(0, i);
						String string2D_Arr=keyAndValue.substring(i+6, keyAndValue.length());
	...
	private int[] convertToIntArray(String string){
		...
		int beginIndex=0;
		int endIndex=0;
		for(int i=6;(i+6)<string.length();i++){
			if(string.substring(i,i+6).equals(",,,,,,") || string.substring(i,i+6).equals("]]]]]]")){
				beginIndex=endIndex+6;
				endIndex=i;
	...
	private double[] convertToDoubleArray(String string){
		...
		for(int i=6;(i+6)<string.length();i++){
			if(string.substring(i,i+6).equals(",,,,,,") || string.substring(i,i+6).equals("]]]]]]")){
				...
				String value=string.substring(beginIndex, endIndex);
				if(stringIsEmpty(value)==false){
					doubleList.add(Double.parseDouble(string.substring(beginIndex, endIndex)));
				}
			}
		}
	...
	private int[][] convertToTwoDimensionalIntArray(String string){
		...
		for(int i=0;(i+5)<string.length();i++){
			if(string.substring(i, i+6).equals("[[[[[[") ){
				beginIndex=i+6;
			}
			if(string.substring(i, i+6).equals("]]]]]]")){
				endIndex=i;
		...
		for(int i=0;i<columnList.size();i++){
			...
			cols=0;
			rows++;
			for(int q=0;(q+5)<index.length();q++){
				if(index.substring(q, q+6).equals(",,,,,,")){
					endIndex=q;
	...
	private double[][] convertToTwoDimensionalDoubleArray(String string){
		...
		for(int i=0;i<valueList.size();i++){
			if(i!=0 && valueList.get(i).equals("######_NewDimension_######")){
				...
				array[rows][cols]=Double.parseDouble(valueList.get(i));
				cols++;
			}
		}
		return array;
